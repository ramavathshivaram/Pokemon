...
import { displayPokemonList, displayPokemonDetails } from "./Display.js";
...
const eventMappings = [
  ...
  { id: "sideBtnSearch", func: MY_FUNCTIONS.displaySearch },
  { id: "sideBtnPokemonDetails", func: MY_FUNCTIONS.displayPokemonContainer },
  { id: "sideBtnCompare", func: MY_FUNCTIONS.displayCompare },
  { id: "sideBtnGame", func: MY_FUNCTIONS.displayGame },
  { id: "sideBtnAbout", func: MY_FUNCTIONS.displayAbout },
  ...
  },
  {
    ...
    func: () => {
      document.getElementById("sideBarMenutogle").classList.toggle("active");
    },
  },
];
...
const toggleMappings = [
  {
    triggerId: "searchPokemonContainer",
    targetId: "searchPokemon",
    extraFunc: MY_FUNCTIONS.allTypes,
  },
  { triggerId: "sortedPokemonContainer", targetId: "sortedPokemon" },
  {
    triggerId: "powerInTypeContainer",
    targetId: "powerInType",
    extraFunc: MY_FUNCTIONS.powerInTypes,
  },
  {
    triggerId: "moves",
    targetId: "movesContainer",
    extraFunc: MY_FUNCTIONS.displayAllMoves,
  },
  {
    triggerId: "abilities",
    targetId: "abilitiesContainer",
    extraFunc: MY_FUNCTIONS.displayAllAbilities,
  },
